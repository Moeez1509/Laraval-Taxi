...
<head>
    ...
    <meta content="Myra Studio" name="author" />
          <link rel="shortcut icon" href="taxi/assets/images/favicon.ico">

    <link href="taxi/assets/libs/morris.js/morris.css" rel="stylesheet" type="text/css" />

    <!-- App css -->
    <link href="taxi/assets/css/style.min.css" rel="stylesheet" type="text/css">
    <link href="taxi/assets/css/icons.min.css" rel="stylesheet" type="text/css">
    <script src="taxi/assets/js/config.js"></script>
...
<body>
        ...
        <div class="main-menu">
            ...
            <div class="logo-box">
                ...
                <a class='logo-light' href='index.php'>
                    <img src="taxi/assets/images/logo-light.png" alt="logo" class="logo-lg" height="32">
                    <img src="taxi/assets/images/logo-light-sm.png" alt="small logo" class="logo-sm" height="32">
                </a>

                <!-- Brand Logo Dark -->
                <a class='logo-dark' href='index.php'>
                    <img src="taxi/assets/images/logo-dark.png" alt="dark logo" class="logo-lg" height="32">
                    <img src="taxi/assets/images/logo-dark-sm.png" alt="small logo" class="logo-sm" height="32">
                </a>
            </div>
 ...
 <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <div><script>document.write(new Date().getFullYear())</script>2026 © Scoxe</div>
                        </div>
                        <div class="col-md-6">
